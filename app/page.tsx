        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Image
                src="/Professional-printing-and-design-work.jpg?height=400&width=300"
                alt="Professional printing and design work"
                width={360}
                height={400}
                className="rounded-2xl shadow-2xl w-full h-[300px] lg:h-[450px] object-cover "
              />
              {/* <img 
...
//           <div className="relative hidden md:block top-10">
//             {/* Team Images */}
//             <div className="relative  t-[20px]">
//               <div className="absolute top-[-70px]  left-0 w-80 h-74 rounded-3xl overflow-hidden border-4 border-orange-500/30">
//                 <Image
...
//                 />
//               </div>
//               <div className="absolute top-1 right-0 w-80 h-74 rounded-3xl overflow-hidden border-4 border-orange-500/30">
//                 <Image
...
//             {/* Decorative Elements */}
//             <div className="absolute -top-1 -left-10 w-32 h-32 bg-orange-500/30 rounded-full blur-2xl"></div>
//             <div className="absolute -bottom-1 -right-10 w-40 h-40 bg-orange-500/20 rounded-full blur-2xl"></div>
//           </div>
//         </div>
